  ...
  return (
    <>
      <SEO
        ...
        description="view AfterROOT's Privacy Policy"
      />
      <Layout title="Privacy Policy">
        <main className="main">
          <div className="m-3 w-auto">
            ...
            <h6 className="mt-1 text-xl">Information Collection and Use</h6>
            <p>
              For a better experience, while using our Service, I may require
              you to provide us with certain personally identifiable
              information, including but not limited to Device Name, Device ID.
            ...
            <h6 className="mt-1 text-xl">Log Data</h6>
            <p>
              {" "}
            ...
            <h6 className="mt-1 text-xl">Cookies</h6>
            <p>
            ...
            <h6 className="mt-1 text-xl">Service Providers</h6>
            <p>
              {" "}
            ...
            <h6 className="mt-1 text-xl">Security</h6>
            <p>
              {" "}
            ...
            <h6 className="mt-1 text-xl">Links to Other Sites</h6>
            <p>
            ...
            <h6 className="mt-1 text-xl">Children’s Privacy</h6>
            <p>
            ...
            <h6 className="mt-1 text-xl">Changes to This Privacy Policy</h6>
            <p>
              {" "}
            ...
            <h6 className="mt-1 text-xl">Contact Us</h6>
            <p>
